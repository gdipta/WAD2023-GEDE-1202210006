...
if (isset($_POST["berat_badan"]) && isset($_POST["tinggi_badan"])) {
...
if ($berat == null || $tinggi == null) {
    $php_errormsg = "Tinggi badan dan Berat badan tidak boleh kosong";
}
// **********************  2  ************************** 
...
// silakan taruh code kalian di bawah
if ($tinggi != null && $tinggi != null) {
    $result = $berat * ($tinggi / 100) ** 2;
    if ($result <= 18.4) {
        $status = "Underweigth";
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    if (isset($result)) {
                        echo "Hasil Perhitungan BMI : " . $result;
                        echo "<br/>";
                        echo "Status : " . $status;
                    } ?>
                    <!--  **********************  4  **************************     -->
                    ...
                    if (isset($php_errormsg)) {
                        echo "Error : Tinggi atau Berat badan tidak boleh kosong";
                    } ?>
                    <!--  **********************  5  **************************     -->
